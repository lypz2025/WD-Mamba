...
def get_nnet(name, pretrained_path=None, is_init_mamba=False, **kwargs):
    if 'Mamba_DiT' in name: # DiM # celeba.py, imagenet256_H_DiM.py
    ...
    elif 'Mamba_UViT' in name: # U_1 # celeba_3
        from mamba_attn_diff.models.mamba_2d_uvit import Mamba2DModel as Mamba_DiT
        model = Mamba_DiT(**kwargs)
        # initialize_weights(model)
        init_embedders(model)
        # # # init_adaLN_modulation_layers(model)
    ...
    elif 'Mamba_UViT_2' in name: # U_2
        from mamba_attn_diff.models.mamba_2d_uvit_2 import Mamba2DModel as Mamba_DiT
        model = Mamba_DiT(**kwargs)
        # initialize_weights(model)
        init_embedders(model)
        # # # init_adaLN_modulation_layers(model)
    ...
    elif name == 'Mamba_WViT': # W # # celeba_wvit.py, 
        from mamba_attn_diff.models.mamba_2d_wvit import Mamba2DModel as Mamba_DiT
        model = Mamba_DiT(**kwargs)
        # initialize_weights(model)
        init_embedders(model)
        # # # init_adaLN_modulation_layers(model)
    ...
    elif name == 'Mamba_WViT_Cifar10': # W # # cifar10, 
        from mamba_attn_diff.models.mamba_2d_cifar10_wvit import Mamba2DModel as Mamba_DiT
        model = Mamba_DiT(**kwargs)
        # initialize_weights(model)
        init_embedders(model)
        # # # init_adaLN_modulation_layers(model)
    ...
    # elif name == 'Mamba_WViT_2': # Half-V
    #     from mamba_attn_diff.models.mamba_2d_wvit_2 import Mamba2DModel as Mamba_DiT
    #     model = Mamba_DiT(**kwargs)
    #     # initialize_weights(model)
    #     init_embedders(model)
    #     # # # init_adaLN_modulation_layers(model)
    ...
    # elif name == 'Mamba_WViT_3': # Double U of DiM - celeba_wvit_3
    #     from mamba_attn_diff.models.mamba_2d_wvit_3 import Mamba2DModel as Mamba_DiT
    #     model = Mamba_DiT(**kwargs)
    #     # initialize_weights(model)
    #     init_embedders(model)
    #     # # # init_adaLN_modulation_layers(model)
    ...
    elif name == 'Mamba_WViT_50': # W # # imagenet_wvit_50.py, 
        from mamba_attn_diff.models.mamba_2d_wvit_50 import Mamba2DModel as Mamba_DiT
        model = Mamba_DiT(**kwargs)
        # initialize_weights(model)
        init_embedders(model)
        # # # init_adaLN_modulation_layers(model)
    ...
    elif name == 'Mamba_WViT_98': # W # # imagenet_wvit_98.py, 
        # from mamba_attn_diff.models.mamba_2d_wvit_98_1 import Mamba2DModel as Mamba_DiT
        from mamba_attn_diff.models.mamba_2d_wvit_98_2 import Mamba2DModel as Mamba_DiT
        model = Mamba_DiT(**kwargs)
        # initialize_weights(model)
        init_embedders(model)
        # # # init_adaLN_modulation_layers(model)
    ...
    elif name == 'Mamba_DiM': # Original DiM- U-shape
        from mamba_attn_diff.models.mamba_2d_dim import Mamba2DModel as Mamba_DiT
        model = Mamba_DiT(**kwargs)
        # initialize_weights(model)
        init_embedders(model)
        # # # init_adaLN_modulation_layers(model)
