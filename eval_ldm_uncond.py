...
def evaluate(config):
    ...
    with tempfile.TemporaryDirectory() as temp_path:
        ...
        # if accelerator.is_main_process:
            # ref_stats_path = '/scratch/laks/fid/ref_stats/u-vit/fid_stats/fid_stats_celeba64_train_50000_ddim.npz' # Updated code
            # fid = calculate_fid_given_paths((ref_stats_path, path)) # # Updated code
